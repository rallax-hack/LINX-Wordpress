...
function businessfocus_promo_head_options( $wp_customize ) {
	$wp_customize->add_section( 'photofocus_promotion_headline', array(
			'title' => esc_html__( 'Promotion Headline', 'businessfocus' ),
	...
	photofocus_register_option( $wp_customize, array(
			...
			'label'             => esc_html__( 'Enable on', 'businessfocus' ),
	...
	photofocus_register_option( $wp_customize, array(
			...
			'label'             => esc_html__( 'Promotion Headline Image', 'businessfocus' ),
			'section'           => 'photofocus_promotion_headline',
		)
	);
	...
	photofocus_register_option( $wp_customize, array(
			...
			'active_callback'   => 'photofocus_is_promotion_headline_active',
			'label'             => esc_html__( 'Page', 'businessfocus' ),
			'section'           => 'photofocus_promotion_headline',
			'type'              => 'dropdown-pages',
		)
	);
	...
	photofocus_register_option( $wp_customize, array(
			...
			'active_callback'   => 'photofocus_is_promotion_headline_active',
			'label'             => esc_html__( 'Sub Title', 'businessfocus' ),
			'section'           => 'photofocus_promotion_headline',
			'type'              => 'textarea',
		)
	);
...
add_action( 'customize_register', 'businessfocus_promo_head_options', 100 );
